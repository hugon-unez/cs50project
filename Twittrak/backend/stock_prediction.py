...
from backend.twitter_data import twitter_stuff
from backend.stock_data import recent_price

def predicted_change(username):
    # check if input is valid
    if twitter_stuff(username) == 44 or twitter_stuff(username) == 45:
    ...
    csv_data = twitter_stuff(username)
